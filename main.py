...
#create_boxplot(data_SA,'SA_Nederland', 'Iteraties', iteraties, 'Simulated Annealing', "SimAnnealing")

# Voor verschillende temperaturen op 200000 iteraties checken
iteraties = [20000]
...
#create_boxplot(data_SA_temp,'SA_temptest', 'Temperatuur', temp, 'Simulated Annealing', "SimAnnealing")
...
#iteraties = [200, 500, 1000, 2000, 5000, 10000, 20000]
#experiment = generate_experiment(SimAnnealing, iteraties, 150, alle_trajecten_holland, 20, "Holland-temp30", G_holland, 'random', temperatuur=30)
#experiment.run_experiment()
